// src/pipeline/module1_extractor/pdfTextExtractor.ts
/**
 * Rule-based PDF Extractor for CLSG-IR Module 1 (zero-LLM, runs fully in the browser).
 * Used when there is no Gemini key or the Vision path fails (quota, 429, timeout): see pdfExtractor.ts.
 *
 * Per page:
